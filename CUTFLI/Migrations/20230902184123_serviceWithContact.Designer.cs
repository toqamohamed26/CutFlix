...
namespace CUTFLI.Migrations
{
    ...
    [Migration("20230902184123_serviceWithContact")]
    partial class serviceWithContact
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CUTFLI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Irbid",
                            CreatedDate = new DateTime(2023, 9, 2, 21, 41, 22, 852, DateTimeKind.Local).AddTicks(6243),
