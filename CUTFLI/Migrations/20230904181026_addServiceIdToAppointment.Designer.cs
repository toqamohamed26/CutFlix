...
namespace CUTFLI.Migrations
{
    ...
    [Migration("20230904181026_addServiceIdToAppointment")]
    partial class addServiceIdToAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CUTFLI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Irbid",
                            CreatedDate = new DateTime(2023, 9, 4, 21, 10, 26, 813, DateTimeKind.Local).AddTicks(654),
